...
<body class="avoid-fout page-blue ">
	<header class="header" style="margin-top:0px;">		
		<img src="<?php echo base_url('assets/img/logo/innova-blanco.png');?>" style="width:110px;height:auto">
	</header>
											...
											<div class="form-group form-group-label">
												<div class="row">
													<div class="col-md-10 col-md-push-1">
														...
														<input class="form-control center"  type="text" name="txtUsuario">
													</div>
												</div>
											</div>											
											<div class="form-group form-group-label">
												<div class="row">
													<div class="col-md-10 col-md-push-1">
														...
														<input class="form-control center"  type="password" name="txtpassword">
													</div>
												</div>
											</div>											
